...
public class ManageSellPriceIndexSubAdapter extends RecyclerView.Adapter<ManageSellPriceIndexSubAdapter.MyViewHolder> {
    ...
    public ManageSellPriceIndexSubAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
