...
public class CommitionHistorySuccessFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.agency_commition_history_success_fragment,container,false);
    }
...
//        prepare_data();
        adapter = new CommitionHistoryAdapter(parent.array_success,parent);
    ...
    public void show_data(){
        ...
        total_commition.setText("Rp. "+parent.formatter.format(parent.total_success_commition_data));
