...
public class CommitionHistoryFilterAdapter extends RecyclerView.Adapter<CommitionHistoryFilterAdapter.MyViewHolder> {
    ...
    public CommitionHistoryFilterAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
