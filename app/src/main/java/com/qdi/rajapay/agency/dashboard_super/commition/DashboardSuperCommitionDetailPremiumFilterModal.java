...
public class DashboardSuperCommitionDetailPremiumFilterModal extends BottomSheetDialogFragment {
    ImageView cancel;
    RecyclerView list;
    ...
    DashboardSuperCommitionDetailPremiumActivity parent;
            ...
            public void onClick(final int position, final boolean selected) {
                try {
                    if(selected){
                        ...
                        parent.get_data();
//                        parent.get_data(array.get(position).has("month") ?
//                                array.get(position).getString("month") : "");
                        dismiss();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
    ...
    private void init(View view) throws JSONException {
        ...
        parent = (DashboardSuperCommitionDetailPremiumActivity) getActivity();
