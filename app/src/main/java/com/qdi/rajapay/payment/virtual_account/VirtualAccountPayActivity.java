 ...
 * @screen 4.1.3.5
 */
public class VirtualAccountPayActivity extends BaseActivity implements APICallback.ItemCallback<OrderData> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                VirtualAccountPaymentDetailModal modal = new VirtualAccountPaymentDetailModal();
        ...
        how_to_pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 */
                // <code>
                startActivity(new Intent(VirtualAccountPayActivity.this, HowToPayActivity.class)
...
//                    data.getJSONObject("data").put("date",new SimpleDateFormat("dd MMMM yyyy").format(new Date()));
                startActivity(new Intent(VirtualAccountPayActivity.this, ContactUsListActivity.class));
//                } catch (JSONException e) {
//                    e.printStackTrace();
//                }
            }
...
//        bank_icon.setImageDrawable(getResources().getDrawable(data_payment.getInt("image")));
    ...
    private void submit() throws JSONException {
        ...
        arr.put("typeTxn","TOPUPDEPOSITVA");
        ...
        url = BASE_URL+"/mobile/deposit/topup-va";
        show_wait_modal();
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            reportData.setTypeTxn(TransactionType.TOPUP_DEPOSIT_VA);
        ...
        api.getOrderDetail(selected, VirtualAccountPayActivity.this);
    }
    ...
    public void onItemResponseSuccess(OrderData item, String message) {
        ...
        finish();
        startActivity(new Intent(VirtualAccountPayActivity.this, OrderDetailActivity.class)
                .putExtra("data",item));
    }
    // </code>
}