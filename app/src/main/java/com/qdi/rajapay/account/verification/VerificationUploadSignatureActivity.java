 ...
 * @screen 8.7.7
 */
public class VerificationUploadSignatureActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_account_verification_upload_signature);

        init_toolbar(getResources().getString(R.string.activity_title_signature));
        try {
            init();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    if(image_uri == null) {
                        show_error_message(layout, getResources().getString(R.string.account_verification_upload_signature_empty_picture));
                        return;
                    }
                    data.put("signature_uri", image_uri);
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            finish();
                            startActivity(new Intent(VerificationUploadSignatureActivity.this, VerificationIntroActivity.class)
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ChooseMediaPickerModal modal = new ChooseMediaPickerModal("sign.jpg");
        ...
        example.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                VerificationUploadSignatureModal modal = new VerificationUploadSignatureModal();
                modal.show(getSupportFragmentManager(),"modal");
            }
        });
    }
    ...
    private void init() throws JSONException {
        ...
        String contentUri = data.getString("signature_uri");
