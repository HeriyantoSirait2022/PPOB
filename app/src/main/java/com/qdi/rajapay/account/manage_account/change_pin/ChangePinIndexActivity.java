...
public class ChangePinIndexActivity extends BaseActivity {
    EditText pin;
    Button submit;
    NumberKeyboard nk;
    InputConnection ic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init_toolbar(getResources().getString(R.string.account_manage_account_change_pin_index_toolbar));
        init();
        action();
    }
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(pin.getText().toString().equals(""))
                    show_error_message(layout,getResources().getString(R.string.account_manage_account_change_pin_empty_pin));
    ...
    private void submit() throws JSONException {
        ...
        if(getIntent().hasExtra("reqPinChange")){
            if(getIntent().getBooleanExtra("reqPinChange", false)){
                startActivity(new Intent(ChangePinIndexActivity.this, ChangePinConfirmationActivity.class)
