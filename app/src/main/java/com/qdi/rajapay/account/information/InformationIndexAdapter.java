...
public class InformationIndexAdapter extends RecyclerView.Adapter<InformationIndexAdapter.MyViewHolder> {
    ...
    public InformationIndexAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
