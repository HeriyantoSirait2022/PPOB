...
public class AgencyAdapter extends RecyclerView.Adapter<AgencyAdapter.MyViewHolder> {
    ...
    public AgencyAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.main_sublist_item_cardview, viewGroup, false);
