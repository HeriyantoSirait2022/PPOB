...
public class TopUpAdapter extends RecyclerView.Adapter<TopUpAdapter.MyViewHolder> {
    ...
    public TopUpAdapter(ArrayList<JSONObject> arr,Context context) {
        this.arr=arr;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.top_up_list_item, viewGroup, false);
