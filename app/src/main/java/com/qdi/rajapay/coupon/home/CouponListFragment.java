 ...
 * @screen 4.21.1.2
 */
public class CouponListFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public CouponListFragment(boolean flagBanner, boolean flagUse){
