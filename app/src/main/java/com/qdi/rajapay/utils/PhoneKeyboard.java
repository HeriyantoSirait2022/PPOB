...
public class PhoneKeyboard extends LinearLayout implements View.OnClickListener {
    ...
    public PhoneKeyboard(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    /**
     * @author Jesslyn
     * @note add enabled/disabled function to all child view
     * @param enabled
     */
    // <code>
    @Override
    public void setEnabled(boolean enabled) {
        ...
        buttonEnter.setEnabled(enabled);
        buttonDelete.setEnabled(enabled);
        button000.setEnabled(enabled);
    }
    // </code>

    public PhoneKeyboard(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        /**
         * @author Jesslyn
         * @note 1. set button 000 to handling enabled function
         *       2. Disable buton000, following figma design
         */
        // <code>
        button000 = (Button) findViewById(R.id.button_000);
        // button000.setClickable(false);
        // </code>
