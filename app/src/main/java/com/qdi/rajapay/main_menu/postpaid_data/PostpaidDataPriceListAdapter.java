...
public class PostpaidDataPriceListAdapter extends BaseExpandableListAdapter {
    Context context;
    com.qdi.rajapay.main_menu.postpaid_data.PostpaidDataPriceListAdapter.ClickListener clickListener;
    ArrayList<JSONObject> listDataHeader;
    HashMap<JSONObject, ArrayList<JSONObject>> listChildData;

    public PostpaidDataPriceListAdapter(Context context, ArrayList<JSONObject> listDataHeader, HashMap<JSONObject, ArrayList<JSONObject>> listChildData) {
    ...
    public void setOnItemClickListener(com.qdi.rajapay.main_menu.postpaid_data.PostpaidDataPriceListAdapter.ClickListener clickListener){
