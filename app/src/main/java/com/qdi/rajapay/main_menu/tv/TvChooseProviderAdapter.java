...
public class TvChooseProviderAdapter extends RecyclerView.Adapter<TvChooseProviderAdapter.MyViewHolder> {
    ...
    public TvChooseProviderAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
