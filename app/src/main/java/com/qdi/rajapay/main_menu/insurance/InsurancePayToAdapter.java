...
public class InsurancePayToAdapter extends RecyclerView.Adapter<InsurancePayToAdapter.MyViewHolder> {
    ...
    public InsurancePayToAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
