...
public class MultifinanceChooseSubServiceAdapter extends RecyclerView.Adapter<MultifinanceChooseSubServiceAdapter.MyViewHolder> {
    ...
    public MultifinanceChooseSubServiceAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
