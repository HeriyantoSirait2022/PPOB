...
public class GasPriceListActivity extends BaseActivity {
    RecyclerView list;

    GasPriceListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new GasPriceListAdapter.ClickListener() {
            @Override
            public void onClick(int position) {
                ...
                try {
                    if(array.get(position).getInt("isProblem") == 0)
                        startActivity(new Intent(GasPriceListActivity.this, GasInputNoActivity.class)
                                .putExtra("type","gas")
    ...
    private void init() throws JSONException {
        ...
        adapter = new GasPriceListAdapter(array,this);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (!response_data.getString("type").equals("Failed")) {
                        ...
                        jsonObject.put("text","Tagihan PGN");
