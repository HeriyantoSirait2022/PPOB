...
public class PrepaidDataInputPhoneNoNGRSAdapter extends RecyclerView.Adapter<PrepaidDataInputPhoneNoNGRSAdapter.MyViewHolder> {
    ...
    public PrepaidDataInputPhoneNoNGRSAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
