...
public class TvPriceListAdapter extends BaseExpandableListAdapter {
    Context context;
    ClickListener clickListener;
    ArrayList<JSONObject> listDataHeader;
    HashMap<JSONObject, ArrayList<JSONObject>> listChildData;

    public TvPriceListAdapter(Context context, ArrayList<JSONObject> listDataHeader, HashMap<JSONObject, ArrayList<JSONObject>> listChildData) {
