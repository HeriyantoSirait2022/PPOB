...
public class MultifinancePriceListAdapter extends BaseExpandableListAdapter {
    Context context;
    com.qdi.rajapay.main_menu.multifinance.MultifinancePriceListAdapter.ClickListener clickListener;
    ArrayList<JSONObject> listDataHeader;
    HashMap<JSONObject, ArrayList<JSONObject>> listChildData;

    public MultifinancePriceListAdapter(Context context, ArrayList<JSONObject> listDataHeader, HashMap<JSONObject, ArrayList<JSONObject>> listChildData) {
    ...
    public void setOnItemClickListener(com.qdi.rajapay.main_menu.multifinance.MultifinancePriceListAdapter.ClickListener clickListener){
