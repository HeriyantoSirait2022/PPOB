...
public class InsurancePriceListAdapter extends RecyclerView.Adapter<InsurancePriceListAdapter.MyViewHolder> {
    ...
    public InsurancePriceListAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
