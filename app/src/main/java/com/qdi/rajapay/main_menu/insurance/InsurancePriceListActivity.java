 ...
 * @screen 4.16.6
 */
public class InsurancePriceListActivity extends BaseActivity {
    RecyclerView list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_menu_insurance_price_list);
        ...
        adapter.setOnItemClickListener(new InsurancePriceListAdapter.ClickListener() {
            @Override
            public void onClick(int position) {
                ...
                try {
                    if(array.get(position).getInt("isProblem") == 0)
                        startActivity(new Intent(InsurancePriceListActivity.this, InsuranceInputNoActivity.class)
    ...
    private void init() throws JSONException {
        ...
        adapter = new InsurancePriceListAdapter(array,this);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (!response_data.getString("type").equals("Failed")) {
                        ...
                        jsonObject.put("text","Tagihan BPJS");
