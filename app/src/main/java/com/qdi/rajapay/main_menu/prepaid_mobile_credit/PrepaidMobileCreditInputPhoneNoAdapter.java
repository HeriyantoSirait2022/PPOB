...
public class PrepaidMobileCreditInputPhoneNoAdapter extends RecyclerView.Adapter<PrepaidMobileCreditInputPhoneNoAdapter.MyViewHolder> {
    ...
    public PrepaidMobileCreditInputPhoneNoAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        try {
            ...
            if(data.getInt("isProblem") == 0)
                myViewHolder.status.setBackgroundColor(context.getResources().getColor(R.color.colorPrimary));
            else
                myViewHolder.status.setBackgroundColor(context.getResources().getColor(R.color.danger));
