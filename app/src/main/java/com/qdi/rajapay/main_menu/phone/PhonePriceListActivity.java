 ...
 * @screen 4.19.7
 */
public class PhonePriceListActivity extends BaseActivity {
    ExpandableListView list;

    PhonePriceListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new PhonePriceListAdapter.ClickListener() {
            @Override
            public void onClick(int group_position, int child_position) {
                ...
                // <code>
                /*
                startActivity(new Intent(PhonePriceListActivity.this, PhoneInputNoActivity.class)
    ...
    private void init() throws JSONException {
        ...
        // </code>
        adapter = new PhonePriceListAdapter(this,array_header,array_child);
    ...
    private void prepare_data() throws JSONException {
        for(int x = 0; x < data_provider.length(); x++) {
            data_provider.getJSONObject(x).put("text",data_provider.getJSONObject(x).getString("text"));
...
//        data.put("title", "Telkom");
//        data.put("selected", false);
//        data.put("image",R.drawable.ic_telkomhdpi);
//        array_header.add(data);
//
//        data = new JSONObject();
//        data.put("title", "IndieHome (Speedy)");
//        data.put("selected", false);
//        data.put("image",R.drawable.ic_indihomehdpi);
//        array_header.add(data);
//
//        ArrayList<JSONObject> arr = new ArrayList<>();
//        arr.add(new JSONObject("{\"title\":\"Telkom\",\"price\":10000,\"price_str\":\"Rp. "+formatter.format(10000)+"\"}"));
//        array_child.put(array_header.get(0), arr);
//
//        arr = new ArrayList<>();
//        arr.add(new JSONObject("{\"title\":\"IndieHome (Speedy)\",\"price\":20000,\"price_str\":\"Rp. "+formatter.format(20000)+"\"}"));
