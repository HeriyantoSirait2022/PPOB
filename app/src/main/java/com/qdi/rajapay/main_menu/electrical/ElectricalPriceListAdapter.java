...
public class ElectricalPriceListAdapter extends RecyclerView.Adapter<ElectricalPriceListAdapter.MyViewHolder> {
    ...
    public ElectricalPriceListAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
