 ...
 * @screen 4.11.2
 */
public class PrepaidMobileCreditInputPhoneNoModal extends BottomSheetDialogFragment {
    // <code>
    ...
    PrepaidMobileCreditInputPhoneNoActivity parent;
    Double admin_cost;
        ...
        buy_now.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    data.put("url_post","/mobile/prepaid/pulsa-transaction");
                    data.put("url_pay","/mobile/prepaid/topup-pulsa");
    ...
    private void init(View view) throws JSONException {
        ...
        parent = (PrepaidMobileCreditInputPhoneNoActivity) getActivity();
        /**
         * @author Jesslyn
    ...
    private JSONObject add_data_to_post() throws JSONException {
        ...
        jsonObject.put("typeTxn","PREPAIDPULSA");
        ...
        jsonObject.put("productType","PULSA");
        ...
        jsonObject.put("codePulsa",parent.data_selected.getString("codePulsa"));
        jsonObject.put("namePulsa",parent.data_selected.getString("namePulsa"));
        jsonObject.put("detailPulsa",parent.data_selected.getString("detailPulsa"));
