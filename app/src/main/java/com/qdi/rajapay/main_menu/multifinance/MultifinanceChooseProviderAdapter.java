...
public class MultifinanceChooseProviderAdapter extends RecyclerView.Adapter<MultifinanceChooseProviderAdapter.MyViewHolder> {
    ...
    public MultifinanceChooseProviderAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
