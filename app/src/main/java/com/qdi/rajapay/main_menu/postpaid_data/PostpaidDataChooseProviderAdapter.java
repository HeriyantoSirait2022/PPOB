...
public class PostpaidDataChooseProviderAdapter extends RecyclerView.Adapter<PostpaidDataChooseProviderAdapter.MyViewHolder> {
    ...
    public PostpaidDataChooseProviderAdapter(ArrayList<JSONObject> arr, Context context) {
        this.arr=arr;
