...
import com.qdi.rajapay.main_menu.emoney.EmoneyProductSelectAdapter;
 ...
 * @screen 4.24.1
 */
public class BankTransferSelectActivity extends BaseActivity {
    RecyclerView list;
        ...
        adapter.setOnItemClickListener(new EmoneyProductSelectAdapter.ClickListener() {
            ...
            public void onClick(int position) {
                if(search.getText().length() == 0){
                    ...
                    startActivity(new Intent(BankTransferSelectActivity.this, BankTransferInputActivity.class)
    ...
    private void init() {
        ...
        search.setHint(R.string.hint_search_bank);
        ...
        chooseProduct.setText(R.string.main_menu_banktransfer_choose_product);
    }
    ...
    private void get_data() throws JSONException {
        show_wait_modal();
        url = BASE_URL+"/mobile/prepaid/banktransfer-list";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (!response_data.getString("type").equals("Failed")) {
                        JSONObject emoneyList = response_data.getJSONObject("bankTransferList");

                        JSONArray jsonArray = emoneyList.getJSONArray("BANKTRANSFER");
                        array.clear();
